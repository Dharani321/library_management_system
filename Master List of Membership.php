...
<?php
  ...
  $sql="SELECT * FROM `library`.`master_membership`";
...
$result= mysqli_query($conn,$sql);
  ...
  ?>
    ...
    <div class="container">
        ...
        <div>
        <h3 style="text-align:center;text-decoration:underline;background-color: grey;text-decoration:none;color:white">Master List of Membership</h3>
